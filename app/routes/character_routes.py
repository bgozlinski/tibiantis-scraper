...
def create_character_blueprint(character_service: CharacterService):
    """
    Create the character blueprint with injected service.

    Args:
        character_service: The character service to use
